        ...
        <div class="row">
          <div class="banner-text text-center">
            <div class="text-border">
              <h2 class="text-dec">University of Gondar</h2>
            </div>
            <div class="intro-para text-center quote">
              <p class="big-text">Serving the community since 1954.</p>
              <a href="{{route('register.create')}}" class="btn get-quote">Join Our Comunity</a>
            </div>
